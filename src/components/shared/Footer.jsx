...
const Footer = () => {
  const HomechefUrl =
    "https://docs.google.com/forms/d/e/1FAIpQLSdoQDcz8AQowT3mQVkrpIelZGqTJRV6ecBx-zA4SiUZk5wsaA/viewform";
  return (
    <>
      <div
        style={{
          backgroundImage: "url('/img/homeBannerBg.svg')",
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
        className=" w-full px-[2.7rem] py-[2rem] lg:py-[3rem]"
      >
        <div className="flex flex-col w-full  gap-8 md:gap-0 md:flex-row justify-between items-center md:items-start md:relative">
          <div className="flex flex-col items-center  gap-2 md:items-start w-full md:w-[40%]">
            ...
            <div className="text-theme-black max-w-[20rem] md:text-[1rem] leading-[20px] font-semibold text-justify">
              Busy lifestyles often lead to unhealthy food choices. FGITO offers
              a permanent solution, ensuring you get nutritious, home-cooked
          ...
          <div className=" w-full md:w-[60%] h-full flex flex-col justify-start items-center md:items-end gap-8 md:gap-0">
            ...
            <div className="flex md:items-start gap-4 md:absolute md:bottom-0">
              ...
              <a href="https://www.instagram.com/fgito_app/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="30"
                  height="30"
                  fill="currentColor"
                  class="bi bi-instagram text-theme-red-100"
                  viewBox="0 0 16 16"
                >
              ...
              <a href="https://wa.me/+918081221164">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="30"
                  height="30"
                  fill="currentColor"
                  className="bi bi-whatsapp text-theme-red-100"
                  viewBox="0 0 16 16"
                >
