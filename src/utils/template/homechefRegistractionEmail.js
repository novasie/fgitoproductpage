...
export const homeChefRegistrationEmailTemplateAdmin = (data) => {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <title>New HomeChef Registration - Admin Review Required</title>
        <style>
            * {
                margin: 0;
                padding: 0;
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p><strong>Admin Alert:</strong> A new HomeChef has registered on the platform and requires verification before approval.</p>
                
                <div class="chef-details">
                    <h3 style="margin-bottom: 20px; color: #8e44ad;">👨‍🍳 Registration Details for Review</h3>
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">
                            <span class="status-badge ${data.fssaiLicence === 'yes' ? 'status-approved' : 'status-pending'}">
                                ${data.fssaiLicence === 'yes' ? '✓ Provided' : '❌ Not Provided'}
                            </span>
                        </span>
                    </div>
                </div>
                ...
                <div style="background-color: #f8d7da; border: 1px solid #f5c6cb; border-radius: 4px; padding: 15px; margin: 20px 0;">
                    <strong>⚠️ Warning:</strong> This chef has not provided FSSAI license information. Manual verification required before approval.
                </div>
                ` : ''}
              </div>
...
export const homeChefRegistrationEmailTemplateUser = (data) => {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
